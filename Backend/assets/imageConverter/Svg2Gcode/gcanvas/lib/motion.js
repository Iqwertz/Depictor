...
Motion.prototype = {
  retract: function() {
    this.ctx.driver.stopLaser.call(this.ctx.driver);
    // this.rapid({z:this.ctx.retract});
  }
, plunge: function() {
    this.ctx.driver.startLaser.call(this.ctx.driver, {s: 1000});
...
, postProcess: function(params) {
    ...
    // Round down the decimal points to 1000 nanometers  [Edit - Iqwertz]
