...
// Constants 
float global_gcode_scale = 0.25; //if 0 scale is auto. calculated
...
float   pen_width = 0.65;               //mm, determines image_scale, reduce, if solid black areas are speckled with white holes. //0.65
int     pen_count = 1;
...
float   grid_scale = 10.0;              // Use 10.0 for centimeters, 25.4 for inches, and between 444 and 529.2 for cubits.
