...
- Open a browser and enter the ip of your rpi in the browser to access the web interface. If everything was successfull you should see the depictor landing page! 
